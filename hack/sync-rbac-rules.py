...
clusterconnections). The temporary manager-cluster-role retains namespaces get
for namespace-UID fallback and subjectaccessreviews during the one-release
webhook migration.
"""
import re
import sys
