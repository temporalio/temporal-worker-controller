...
temporal workflow update-options \
  --query "WorkerDeploymentVersion='$1:$2' AND ExecutionStatus='Running'" \
...
echo "https://cloud.temporal.io/namespaces/${NAMESPACE}/workflows?query=BuildIds+IN+%28%22${SOURCE_BUILD_ID_ENCODED}%22%29+AND+WorkerDeploymentVersion+%3D+%22${TARGET_DEPLOYMENT_VERSION_ENCODED}%22"
